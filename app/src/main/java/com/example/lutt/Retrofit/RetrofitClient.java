...
import com.example.lutt.BuildConfig;
...
public class RetrofitClient extends Activity {
    ...
    public static String BASEURI = "http://192.168.31.70:8080/lottery/api/";


    public static final String HEADER_CACHE_CONTROL = "Cache-Control-Lottery";
    public static final String HEADER_PRAGMA = "Pragma-Lottery";
